...
class complex_spinor{
	...
	//GET Y SET		
		...
		const gsl_complex complex_spinor_get(const int & i, SPIN spin_i) const; //return the i-th
											// element with a given spin component 	
		...
		int numSites() const; //devuelve el numero de Sitios del spinor
